...
export function LeaveTributeForm() {
      ...
      <div className="text-center py-10 px-4">
        <div className="mx-auto max-w-md rounded-2xl bg-card border border-border/60 p-8">
          ...
          <p className="mt-3 text-foreground/80 leading-relaxed">
            Your words are a precious gift, and a true comfort to us. Thank you
            for remembering Princess Gloria with such love.
          </p>
        </div>
        <button
          type="button"
  ...
  return (
    <form onSubmit={onSubmit} className="space-y-5 text-left" noValidate>
      ...
      <Field id="lp-phone" label="Phone (optional, private)">
        <input id="lp-phone" type="tel" value={phone}
