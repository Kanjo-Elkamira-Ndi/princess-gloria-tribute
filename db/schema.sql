...
CREATE INDEX IF NOT EXISTS idx_gallery_photo_status ON gallery_photo (status);
CREATE INDEX IF NOT EXISTS idx_gallery_photo_reviewed_at ON gallery_photo (reviewed_at DESC NULLS LAST);
